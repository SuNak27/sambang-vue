<template>
  <div class="modal fade" id="tambah_hari" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
        ...
        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
          ...
          >
            ...
            <div class="mb-13 text-center">
              <!--begin::Title-->
              <h1 class="mb-3">Tambah Data Hari</h1>
              <!--end::Title-->
            </div>
            <!--end::Heading-->
            <!--begin::Input group-->
            ...
            <div class="d-flex flex-column mb-8 fv-row">
              <!--begin::Label-->
              <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                <span class="required">Nama Wilayah</span>
              </label>
              <!--end::Label-->
              <VSelect
                v-model="hari.id_wilayah"
                addClass="form-control form-control-sm"
                searchPlaceholder="Cari..."
...
export default {
  ...
  methods: {
    simpanHari() {
      var e = document.querySelector("#kt_modal_new_target_submit");
      ...
      if (
        ...
        this.hari.nama_hari = this.hari.nama_hari.value;
        this.hari.id_wilayah = this.hari.id_wilayah.value;
        this.hari.id_shift = this.hari.id_shift.value;
        axios
          .post("/hari", this.hari)
          .then((response) => {
            if (response.status) {
